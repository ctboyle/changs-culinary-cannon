...
float4 PixelShaderFunction(VertexShaderOutput input) : COLOR0
{
	...
	color0 = tex2D (SamplerBottom, input.Tex * bottomTextureTesselationMultiplier); //Note that the grass should be tessellated 
	color1 = tex2D (SamplerMiddle, input.Tex * centerTextureTesselationMultiplier);   // twice as much as the snow and the rock.
	color2 = tex2D (SamplerTop, input.Tex * topTextureTesselationMultiplier);
