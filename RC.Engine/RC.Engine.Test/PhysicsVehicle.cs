...
namespace RC.Physics
{
    public class JigLibXVehicle : JibLibXObject
    {
        ...
        protected override bool OnCollision(JigLibX.Collision.CollisionSkin skin0, JigLibX.Collision.CollisionSkin skin1)
        {
            if (skin1.Owner.ExternalData is Potato)
            {
                int i = 0;
                i++;
                _player.Die();
            ...
            : base()
        {
            ...
            _car.Chassis.Skin.callbackFn += OnCollision;
